...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "leaves.pagination.StandardResultsSetPagination",
    "PAGE_SIZE": 10,
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "APIs for employee leave application and manager approval workflow.",
    "VERSION": "1.0.0",
...
# Business rules
# ---------------------------------------------------------------------------
MAX_ANNUAL_LEAVES = config("MAX_ANNUAL_LEAVES", default=20, cast=int)

# ---------------------------------------------------------------------------
# Email (console backend - bonus requirement)
# ---------------------------------------------------------------------------
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"
DEFAULT_FROM_EMAIL = "noreply@leavemanagement.local"
